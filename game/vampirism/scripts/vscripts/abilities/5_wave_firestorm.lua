...
function RainOfFireStart( event )
    ...
    event.ability:ApplyDataDrivenModifier(caster, caster.fire_storm_dummy, "modifier_rain_of_fire_thinker", {duration=ability:GetSpecialValueFor("duration")-0.5})
    caster.fire_storm_dummy:AddNewModifier( caster.fire_storm_dummy, nil, "modifier_kill", {duration = 35})
end
