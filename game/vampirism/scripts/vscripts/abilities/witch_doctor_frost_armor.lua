...
LinkLuaModifier("modifier_witch_doctor_frost_armor_buff","abilities/modifier_witch_doctor_frost_armor_buff.lua",LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_witch_doctor_frost_armor_debuff","abilities/modifier_witch_doctor_frost_armor_debuff.lua",LUA_MODIFIER_MOTION_NONE)
